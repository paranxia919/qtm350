...
- You can install it on macOS with `brew install tree` and on Linux/WSL with `sudo apt-get install tree`
...
- Shell scripts are a great tool to automate tasks (and they're quite fast too!)
:::

# And that's all for today! 🥳 {background-color="#2d4563"}

# Thank you very much and see you next week! 😊 🙏🏼{background-color="#2d4563"}
